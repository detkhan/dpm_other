...
<div id="report84-cca-desc" class="alert alert-warning report84-desc" >
    ...
    <td style="width:auto"><a href="#table_secshow3" id='sort17' data-sort='asc'  fromDate='<?php echo $datadate[fromDate] ?>'  toDate='<?php echo $datadate[toDate] ?>' sec='3' colum='c_surgery'>ผ่าตัดเพื่อประคับประคอง</a></td>
    <td style="width:auto"><a href="#table_secshow3" id='sort18' data-sort='asc'  fromDate='<?php echo $datadate[fromDate] ?>'  toDate='<?php echo $datadate[toDate] ?>' sec='3' colum='livrec'>Liver resection</a></td>
    <td style="width:auto"><a href="#table_secshow3" id='sort19' data-sort='asc'  fromDate='<?php echo $datadate[fromDate] ?>'  toDate='<?php echo $datadate[toDate] ?>' sec='3' colum='livhilar'>Liver + Hilar</a></td>
    <td style="width:auto"><a href="#table_secshow3" id='sort20' data-sort='asc'  fromDate='<?php echo $datadate[fromDate] ?>'  toDate='<?php echo $datadate[toDate] ?>' sec='3' colum='whipple'>Whipple's opeation</a></td>
    <td style="width:auto"><a href="#table_secshow3" id='sort21' data-sort='asc'  fromDate='<?php echo $datadate[fromDate] ?>'  toDate='<?php echo $datadate[toDate] ?>' sec='3' colum='hilar'>Hilar resection</a></td>
    <td style="width:auto"><a href="#table_secshow3" id='sort22' data-sort='asc'  fromDate='<?php echo $datadate[fromDate] ?>'  toDate='<?php echo $datadate[toDate] ?>' sec='3' colum='bypass'>Bypass</a></td>
    <td style="width:auto"><a href="#table_secshow3" id='sort23' data-sort='asc'  fromDate='<?php echo $datadate[fromDate] ?>'  toDate='<?php echo $datadate[toDate] ?>' sec='3' colum='biopsy'>Biopsy(EL+Bx)</a></td>
    <td style="width:auto"><a href="#table_secshow3" id='sort24' data-sort='asc'  fromDate='<?php echo $datadate[fromDate] ?>'  toDate='<?php echo $datadate[toDate] ?>' sec='3' colum='needle_biopsy'>Needle Biopsy</a></td>
    <td style="width:auto"><a href="#table_secshow3" id='sort25' data-sort='asc'  fromDate='<?php echo $datadate[fromDate] ?>'  toDate='<?php echo $datadate[toDate] ?>' sec='3' colum='ptbd'>PTBD</a></td>
    <td style="width:auto;"><a href="#table_secshow3" id='sort26' data-sort='asc'  fromDate='<?php echo $datadate[fromDate] ?>'  toDate='<?php echo $datadate[toDate] ?>' sec='3' colum='endoscopic'>Endoscopic Stent</a></td>
    <td style="width:auto;"><a href="#table_secshow3" id='sort27' data-sort='asc'  fromDate='<?php echo $datadate[fromDate] ?>'  toDate='<?php echo $datadate[toDate] ?>' sec='3' colum='chemo_all'>Chemotheraphy(All)</a></td>
    <td style="width:auto;"><a href="#table_secshow3" id='sort28' data-sort='asc'  fromDate='<?php echo $datadate[fromDate] ?>'  toDate='<?php echo $datadate[toDate] ?>' sec='3' colum='chemo_adjuvant'>Chemotheraphy(Adjuvant)</a></td>
    <td style="width:auto;"><a href="#table_secshow3" id='sort29' data-sort='asc'  fromDate='<?php echo $datadate[fromDate] ?>'  toDate='<?php echo $datadate[toDate] ?>' sec='3' colum='medication'>Medication</a></td>
...
<td id="hospital"><a id="drilldown" report_id="<?php  echo $report_id  ?>" hsitecode="<?php echo $key[sitecode]   ?>" title="<?php echo $key[hosname]   ?>" sec="3" data-toggle="modal" data-target="#myModal"><?php echo $key[hosname]   ?></a></td>
